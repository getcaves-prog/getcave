        ...
        <div className="relative w-full max-w-[400px]">
          ...
          <div className="flex items-center justify-between mt-2 px-4 py-3 rounded-b-[16px] bg-cave-stone">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Share to socials (native share sheet on mobile, copy on desktop) */}
              <button onClick={handleShare} className="w-8 h-8 flex items-center justify-center rounded-full text-cave-smoke hover:text-cave-white transition-colors" aria-label="Share to socials">

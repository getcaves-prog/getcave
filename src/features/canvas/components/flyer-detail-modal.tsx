        ...
        <div className="relative w-full max-w-[400px]">
          ...
          <div className="flex items-center justify-between mt-2 px-4 py-3 rounded-b-[16px] bg-cave-stone">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Copy link */}
              <button onClick={async () => { try { await navigator.clipboard.writeText(`${window.location.origin}/flyer/${flyer.id}`); setShareToast(true); setTimeout(() => setShareToast(false), 2000); } catch {} }} className="w-8 h-8 flex items-center justify-center rounded-full text-cave-smoke hover:text-cave-white transition-colors" aria-label="Copy link">
